import type { PaginationSortParams, PaginationSortQuery } from '../types/domain/pagination.types.js';
...
export function getPaginationSortParams(
  ...
  const searchNameTerm = typeof query.searchNameTerm === 'string' ? query.searchNameTerm : undefined;

  const validSortFields = entityType === 'blogs' ? BLOG_SORT_FIELDS : POST_SORT_FIELDS;
